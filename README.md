...
I’m **Ayush Prakash (24MEI10129)** (`Ayush Prakash`, reg no `24MEI10129`). I wrote a few small shell scripts to pull basic system info, check package info, audit a couple of directories, and scan a log file for keyword matches.
...
- `manifesto_Ayush Prakash (24MEI10129).txt` - Example output from the manifesto generator

## How to run the scripts

From the repo directory (`/home/oss-audit-Ayush Prakash (24MEI10129)`):

1. **Make them executable (one-time):**
   - `chmod +x script1.sh script2.sh script3.sh script4.sh script5.sh`![](image.png)
...
2. **Run them:**
   ...
   - `./script5.sh`
     - It asks 3 questions and writes `manifesto_Ayush Prakash (24MEI10129).txt`
